    ...
    Java.deoptimizeEverything();
      ...
      /*Java.enumerateLoadedClasses({
        onMatch: function(name, handle) {
          ...
          if (lname.includes('conscrypt')) {//} && !lname.includes('bytestring') && !lname.includes('buffer')){
            traceClass(name);
          }
        },
        onComplete: function() {
      ...
      /*Java.use('java.net.Socket').isClosed.overload().implementation = function () {
          //LOG('Socket.isConnected.overload', { c: Color.Light.Cyan });
          //printBacktrace();
          return this.isClosed();
      }*/
    /*Java.use('com.android.org.conscrypt.OpenSSLRandom').engineNextBytes.implementation = function (a) {
          //LOG('engineNextBytes.overload', { c: Color.Light.Cyan });
          printBacktrace();
          return this.engineNextBytes(a);
      }*/
